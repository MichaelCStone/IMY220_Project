...
var connectionString = "mongodb+srv://mikestone2002:WypvwNTwnx7hYWAJ@imy220.toaiv.mongodb.net/?retryWrites=true&w=majority&appName=IMY220";
var client = new _mongodb.MongoClient(connectionString);

// CREATE APP
var app = (0, _express["default"])();
app.use(_express["default"].json()); // Middleware for JSON parsing
...
app.use('/api', _api["default"]); // All API routes will be prefixed with /api
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var database, songsCollection, profilesCollection, playlistsCollection, thePort;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          // Set database
          database = client.db("u21497682_PlaylistWebsiteDB_Project");
          songsCollection = database.collection("songs");
          profilesCollection = database.collection("profiles");
          playlistsCollection = database.collection("playlists"); // Expose collections to the app (optional, depending on your API setup)
          ...
          // PORT TO LISTEN TO
          thePort = process.env.PORT || 3000; // Use environment variable or default to 3000
          app.listen(thePort, function () {
            console.log("Listening on http://localhost:".concat(thePort));
          });
          _context.next = 18;
          break;
        case 15:
          ...
          console.error("Error connecting to MongoDB or starting server:", _context.t0);
        case 18:
        case "end":
